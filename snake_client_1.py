    ...
    def start_game(self):
        ...
        class Apple:
            def __init__(self):
                ...
                self.data = {
                    'host': True,
                    'snake_pside': snake.pside,
                    'apple_coords': self.coordinates,
                ...
                snake1.pside = self.data.get('snake1_pside')
                print(self.data)
        ...
        snake1 = Snake(
            [[WINDOW_WIDTH / SIZE - 1, WINDOW_HEIGTH / SIZE - 3],
             ...
             [WINDOW_WIDTH / SIZE - 1, WINDOW_HEIGTH / SIZE - 1]], 'top', 1, color=COLORS['FIOLET'],
        ...
        while running:
            ...
            snake1.pside = data.get('snake1_pside')
